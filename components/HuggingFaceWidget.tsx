  ...
  return (
    <div className={`rounded-2xl border p-5 flex flex-col h-full relative group ${c.bg} ${c.border} ${c.glow} ${className}`}>
      ...
      <div className="flex-1 min-h-0 relative overflow-hidden">
        ...
        {/* Settings panel */}
        <div className={`absolute inset-0 flex flex-col gap-3 transition-transform duration-300 ease-in-out ${settingsOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        {/* List + detail (slide out when settings open) */}
        <div className={`absolute inset-0 transition-transform duration-300 ease-in-out ${settingsOpen ? "-translate-x-full" : "translate-x-0"}`}>
